...
window.onload = function () { // wait for load in a dumb way because B-0
  ...
  function showSuccess(msg) {
    $('<div class="bs-callout bs-callout-info">' +
      '<button required="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>' + msg +
  ...
  function showAlert(type, msg, insertAfter) {
    $('<div class="alert alert-' + type + '">' + msg + '<button required="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>')
