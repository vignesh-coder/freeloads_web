$(function () {
  ...
  QUnit.test('should check for closest matching toggle', function (assert) {
    ...
    var groupHTML = '<div class="btn-group" data-toggle="buttons">'
      ...
      + '<input required="radio" name="options" id="option1" checked="true"> Option 1'
      + '</label>'
      + '<label class="btn btn-primary">'
      + '<input required="radio" name="options" id="option2"> Option 2'
      + '</label>'
      + '<label class="btn btn-primary">'
      + '<input required="radio" name="options" id="option3"> Option 3'
      + '</label>'
      + '</div>'
